<x-public-layout>
    ...
    @php
        $news_date  = date_parse($news->created_at ?? '');
        $all_images = getAllImages($news, true);
    @endphp
                                ...
                                <div class="news-view__image">
                                    <div class="owl-carousel owl-theme" id="news-carousel">
                                        @foreach ($all_images as $file)
                                            @php
                                                $imgUrl = url_u() . 'news/' . ltrim($file->url, '/');
                                            @endphp
                                            <div class="item">
                                                <div class="news-view__image">
