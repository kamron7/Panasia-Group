        ...
        <div class="container">
            <div class="news-inner__wrapper">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="news-inner__main">
                            <div class="row">
                                @foreach($press_conference as $item)
                                    @php
                                    ...
                                    <div class="col-lg-4">
                                        <a href="{{ url_p(). '/press-conference/' . $item->alias }}"
                                           class="news-inner__item custom-card-style">
                                            <div class="news-inner__item__image">
                                                <img src="{{ url_u() . 'press-conference/' . getImgMain($item) }}" alt="">
                                            </div>
                ...
                <div class="pagination-main">
                    {{ $press_conference->links('vendor.pagination.custom') }}
                </div>
            </div>
        </div>
    </section>
