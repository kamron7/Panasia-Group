<x-public-layout>
    ...
    @php
        $news_date  = date_parse($analitik->created_at ?? '');
        // Build $all_images from helper: full file objects with category + url
        $all_images = getAllImages($analitik, true); // true => file objects
    @endphp
                                ...
                                <div class="news-view__image">
                                    <div class="owl-carousel owl-theme" id="news-carousel">
                                        @foreach ($all_images as $file)
                                            @php
                                                $imgUrl = url_u() . 'analitik/' . ltrim($file->url, '/');
                                            @endphp
                                            <div class="item">
                                                <div class="news-view__image">
