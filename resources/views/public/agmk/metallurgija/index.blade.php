        ...
        <div class="container">
            <div class="news-inner__wrapper">
                    ...
                    <div class="col-lg-9">
                        <div class="news-inner__main">
                            <div class="row">
                                ...
                                @foreach ($metallurgija as $item)
                                    @php
                                        $img = getImgMain($item);
                                        $imgUrl = $img ? url_u() . 'metallurgija/' . $img : asset('assets/public/images/avatar.png');
                                    @endphp

                                    <div class="col-lg-4">
                                        <a href="{{ url('metallurgija/' . $item->alias) }}" class="news-inner__item new_min">
                ...
                <div class="pagination-main">
                    {{ $metallurgija->links('vendor.pagination.custom') }}
                </div>
