<x-public-layout>
    ...
    @php
        $news_date  = date_parse($investment->created_at ?? '');
        $all_images = getAllImages($investment, true);
    @endphp
                                ...
                                <div class="news-view__image">
                                    <div class="owl-carousel owl-theme" id="news-carousel">
                                        @foreach ($all_images as $file)
                                            @php
                                                $imgUrl = url_u() . 'investment/' . ltrim($file->url, '/');
                                            @endphp
                                            <div class="item">
                                                <div class="news-view__image">
