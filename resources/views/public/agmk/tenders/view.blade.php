<x-public-layout>
    ...
    @php
        $news_date  = date_parse($tenders->created_at ?? '');
        $all_images = getAllImages($tenders, true);
    @endphp
                                ...
                                <div class="news-view__image">
                                    <div class="owl-carousel owl-theme" id="news-carousel">
                                        @foreach ($all_images as $file)
                                            @php
                                                $imgUrl = url_u() . 'tenders/' . ltrim($file->url, '/');
                                            @endphp
                                            <div class="item">
                                                <div class="news-view__image">
