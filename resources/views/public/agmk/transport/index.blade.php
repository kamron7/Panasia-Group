        ...
        <div class="container">
            <div class="news-inner__wrapper">
                        ...
                        <div class="news-inner__main">
                            <div class="row">
                                ...
                                @foreach ($transport as $item)
                                    @php
                                        $img = getImgMain($item);
                                        $imgUrl = $img ? url_u() . 'transport/' . $img : asset('assets/public/images/avatar.png');
                                    @endphp

                                    <div class="col-lg-4">
                                        <a href="{{ url('transport/' . $item->alias) }}" class="news-inner__item new_min">
                ...
                <div class="pagination-main">
                    {{ $transport->links('vendor.pagination.custom') }}
                </div>
