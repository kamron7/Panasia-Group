...
@include('includes.pages-breadcrumb')
    ...
    @php
        $news_date  = date_parse($sobranie->created_at ?? '');
        $all_images = getAllImages($sobranie, true);
    @endphp
                                ...
                                <div class="news-view__image">
                                    <div class="owl-carousel owl-theme" id="news-carousel">
                                        @foreach ($all_images as $file)
                                            @php
                                                $imgUrl = url_u() . 'sobranie/' . ltrim($file->url, '/');
                                            @endphp
                                            <div class="item">
                                                <div class="news-view__image">
