    ...
    <form action="{{ route('users.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input name="username" class=" form-control input-xlarge focused" id="username" type="text"
                           autocomplete="new-password">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label" for="focusedInput">E-mail</label>
                <input name="email" class="form-control input-xlarge focused" id="email" type="email"
            ...
            <input type="hidden" id="post_id" name="post_id" value="false"/>
